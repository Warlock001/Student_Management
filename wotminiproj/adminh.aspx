<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminh.aspx.cs" Inherits="wotminiproj.adminh" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table class="auto-style1">
            <tr>
                <td>
                    ...
                    <asp:Button ID="dataaddition" runat="server" Text="Data Insertion" OnClick="dataaddition_Click"  />
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyNames="Id" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowDeleting="GridView1_RowDeleting" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating">
            <Columns>
